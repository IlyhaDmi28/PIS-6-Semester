...
app.UseDefaultUser("Administrator", "123456", ["Administrator", "User"]).Wait();
app.UseDefaultUser("Owner", "123456", ["Owner", "User"]).Wait();
app.UseDefaultUser("Guest", "123456", ["Guest", "User"]).Wait();
